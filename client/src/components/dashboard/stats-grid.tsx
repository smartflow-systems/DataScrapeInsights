  ...
  const statItems = [
    {
      ...
      icon: "fas fa-globe",
      iconBg: "bg-sfs-gold-200/10",
      iconColor: "text-sfs-gold-200",
    },
    {
      title: "SQL Queries",
      ...
      iconBg: "bg-sfs-gold-300/10",
      iconColor: "text-sfs-gold-300",
    },
    {
      title: "Data Exports",
      ...
      iconBg: "bg-sfs-gold-400/10",
      iconColor: "text-sfs-gold-400",
    },
    {
      ...
      iconBg: "bg-sfs-gold-100/10",
      iconColor: "text-sfs-gold-100",
    },
  ];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {statItems.map((stat, index) => (
        <Card key={index} className="smartflow-card">
          <CardContent className="p-6">
              ...
              <div>
                ...
                {stat.change !== null && (
                  <p className={`text-xs flex items-center mt-1 ${
                    stat.change > 0 ? "text-green-500" : stat.change < 0 ? "text-destructive" : "text-muted-foreground"
                  }`}>
                    {stat.change !== 0 && (
